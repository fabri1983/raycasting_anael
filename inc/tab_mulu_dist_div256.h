...
/*
    ...
    Instead of dimension 128*PIXEL_COLUMNS we use 128*APPROX_TAB_DELTA_DIST_VALUES to avoid table bigger than 4096 KB. This introduces
    an error for some indices. 
 */
static const u16 tab_mulu_dist_div256[256+1][(1024/(1024/AP) - 1)*APPROX_TAB_DELTA_DIST_VALUES + PIXEL_COLUMNS] = {
0
};
